"""
AhnLab model constants: feature column definitions + LightGBM hyperparameters.

Feature column lists are duplicated from the scraper-service feature pipeline
so that etf-model can reference them without depending on scraper-service.
Model hyperparameters are exclusive to this file.
"""

from typing import List

# ── Feature column definitions (mirrors scraper-service/app/features/ahnlab/constants.py) ──
